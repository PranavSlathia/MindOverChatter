...
ALTER TYPE "public"."memory_type" ADD VALUE 'formative_experience';
--> statement-breakpoint
CREATE TABLE "research_developmental_coverage" (
...
--> statement-breakpoint
CREATE INDEX "research_dev_coverage_user_run_idx" ON "research_developmental_coverage" USING btree ("user_id","experiment_run_id");
--> statement-breakpoint
CREATE INDEX "research_dev_coverage_session_idx" ON "research_developmental_coverage" USING btree ("session_id");
--> statement-breakpoint
CREATE INDEX "research_dev_coverage_dimension_idx" ON "research_developmental_coverage" USING btree ("dimension");
